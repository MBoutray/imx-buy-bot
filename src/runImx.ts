...
const provider = new AlchemyProvider(
    'mainnet',
    '0BZjuaH8NIoewLDSzZRTiRPav7IhD8rT'
)

;(async (): Promise<void> => {
    const privateKey =
        'b308b359c28af946492378c7e8e86e83777b4382ec553ec64ffeaac8e9a153a6'
    ...
    let endpoint =
        'https://api.x.immutable.com/v1/orders?include_fees=true&status=active&sell_token_address=0x9e0d99b864e1ac12565125c5a82b59adea5a09cd&direction=asc&buy_token_address=0xf57e7e7c23978c3caec3c3548e3d615c346e79ff&order_by=buy_quantity&direction=asc&page_size=2'
    ...
    await axios
        ...
        .then((response) => {
            ...
            if (priceFloor < halfPriceFloorSecond) {
                ...
                console.log(
                    new Date().toLocaleString() + ' --- Nothing to buy in IMX'
                )
            }
        })
        .catch((error) => {
