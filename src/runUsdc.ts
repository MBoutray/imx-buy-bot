...
;(async (): Promise<void> => {
    ...
    let endpoint =
        'https://api.x.immutable.com/v1/orders?include_fees=true&status=active&sell_token_address=0x9e0d99b864e1ac12565125c5a82b59adea5a09cd&buy_token_address=0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&page_size=50'
    ...
    await axios
        ...
        .then((response) => {
            ...
            if (priceFloor < halfPriceFloorSecond) {
                ...
                console.log(
                    new Date().toLocaleString() + ' --- Nothing to buy in USDC'
                )
            }
        })
        .catch((error) => {
